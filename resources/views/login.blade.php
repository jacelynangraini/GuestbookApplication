            ...
            <div class="form-container text-18-m ">
                <form class="d-flex flex-column justify-content-around" action="/admin/view">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control text-grey" id="formGroupExampleInput2" placeholder="Enter your email">
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput2" class="text-pink">Password</label>
                        <input type="password" class="form-control text-grey" id="formGroupExampleInput2" placeholder="Enter your password">
                    </div>
