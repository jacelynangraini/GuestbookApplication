        ...
        <div class="mt-4 mb-7 w-75 bg-cream br-50 p4 form-container text-16-m p2-r">
            ...
            <form class="d-flex flex-column justify-content-around" action="/admin/edit/{{$guests->id}}" method="POST">
                ...
                <div class="form-group">
                        ...
                        <input type="text" class="form-control text-grey" id="formGroupExampleInput" placeholder="Enter your name" name="name" value="{{$guests->name}}">
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput2" class="text-pink">Email</label>
                        <input type="email" class="form-control text-grey" id="formGroupExampleInput2" placeholder="Enter your email" name="email" value={{$guests->email}}>
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput2" class="text-pink">Address</label>
                        <input type="text" class="form-control text-grey" id="formGroupExampleInput2" placeholder="Enter your address" name="address" value={{$guests->address}}>
                    </div>
